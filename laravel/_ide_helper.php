...
')
     ...
     */ 
        ...
        namespace HowestSecAndPriv\IotaSignedData\Facades { 
            /**
     * 
     *
     */ 
        class IotaSignedData {
                    /**
         * 
         *
         * @static 
         */ 
        public static function writeHash($hash, $preImage = null)
        {
                        /** @var \HowestSecAndPriv\IotaSignedData\IotaSignedData $instance */
                        return $instance->writeHash($hash, $preImage);
        }
...
namespace  { 
            ...
            class IotaSignedData extends \HowestSecAndPriv\IotaSignedData\Facades\IotaSignedData {}
